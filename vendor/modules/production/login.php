...
<html lang="en">
  <head>
    ...
    <title>Intersog Dashboard | </title>
...
<!--                <a class="btn btn-default submit" name="Submit" href="">Log in</a>-->
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Intersog Dashboard!</h1>
                  <p>©2016 All Rights Reserved. Intersog Dashboard! is an application for project Analysis. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
