...
(
    ...
    `workloghourssum` DOUBLE,
    `worklogusername` VARCHAR(128),
    `workloglogin` VARCHAR(128),
    `worklogkyear` INTEGER,
    `worklogmonth` INTEGER,
    `worklogdatatime` DATETIME,
    `worklogyearmonth` VARCHAR(128),
    `worklogage` INTEGER,
    `countissues` INTEGER,
