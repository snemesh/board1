 ...
 * @method     ChildmyProjectDataQuery orderByProjectName($order = Criteria::ASC) Order by the projectname column
 * @method     ChildmyProjectDataQuery orderByBudget($order = Criteria::ASC) Order by the budget column
 * @method     ChildmyProjectDataQuery orderByTotalEstimated($order = Criteria::ASC) Order by the totalestimated column
 * @method     ChildmyProjectDataQuery orderByTotalSpent($order = Criteria::ASC) Order by the totalspent column
 ...
 * @method     ChildmyProjectDataQuery groupByProjectName() Group by the projectname column
 * @method     ChildmyProjectDataQuery groupByBudget() Group by the budget column
 * @method     ChildmyProjectDataQuery groupByTotalEstimated() Group by the totalestimated column
 * @method     ChildmyProjectDataQuery groupByTotalSpent() Group by the totalspent column
 ...
 * @method     ChildmyProjectData findOneByProjectName(string $projectname) Return the first ChildmyProjectData filtered by the projectname column
 ...
 * @method     ChildmyProjectData findOneByTotalEstimated(double $totalestimated) Return the first ChildmyProjectData filtered by the totalestimated column
 * @method     ChildmyProjectData findOneByTotalSpent(double $totalspent) Return the first ChildmyProjectData filtered by the totalspent column
 ...
 * @method     ChildmyProjectData requireOneByProjectName(string $projectname) Return the first ChildmyProjectData filtered by the projectname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildmyProjectData requireOneByTotalEstimated(double $totalestimated) Return the first ChildmyProjectData filtered by the totalestimated column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildmyProjectData requireOneByTotalSpent(double $totalspent) Return the first ChildmyProjectData filtered by the totalspent column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildmyProjectData[]|ObjectCollection findByProjectName(string $projectname) Return ChildmyProjectData objects filtered by the projectname column
 ...
 * @method     ChildmyProjectData[]|ObjectCollection findByTotalEstimated(double $totalestimated) Return ChildmyProjectData objects filtered by the totalestimated column
 * @method     ChildmyProjectData[]|ObjectCollection findByTotalSpent(double $totalspent) Return ChildmyProjectData objects filtered by the totalspent column
...
abstract class myProjectDataQuery extends ModelCriteria
{
    ...
    public function filterByProjectName($projectName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(myProjectDataTableMap::COL_PROJECTNAME, $projectName, $comparison);
    }
    ...
    public function filterByTotalEstimated($totalEstimated = null, $comparison = null)
    {
        if (is_array($totalEstimated)) {
            ...
            if (isset($totalEstimated['min'])) {
                $this->addUsingAlias(myProjectDataTableMap::COL_TOTALESTIMATED, $totalEstimated['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($totalEstimated['max'])) {
                $this->addUsingAlias(myProjectDataTableMap::COL_TOTALESTIMATED, $totalEstimated['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(myProjectDataTableMap::COL_TOTALESTIMATED, $totalEstimated, $comparison);
    }

    /**
     * Filter the query on the totalspent column
     *
     * Example usage:
     * <code>
     * $query->filterByTotalSpent(1234); // WHERE totalspent = 1234
     * $query->filterByTotalSpent(array(12, 34)); // WHERE totalspent IN (12, 34)
     * $query->filterByTotalSpent(array('min' => 12)); // WHERE totalspent > 12
     * </code>
     *
     * @param     mixed $totalSpent The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildmyProjectDataQuery The current query, for fluid interface
     */
    public function filterByTotalSpent($totalSpent = null, $comparison = null)
    {
        if (is_array($totalSpent)) {
            $useMinMax = false;
            if (isset($totalSpent['min'])) {
                $this->addUsingAlias(myProjectDataTableMap::COL_TOTALSPENT, $totalSpent['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($totalSpent['max'])) {
                $this->addUsingAlias(myProjectDataTableMap::COL_TOTALSPENT, $totalSpent['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(myProjectDataTableMap::COL_TOTALSPENT, $totalSpent, $comparison);
    }
