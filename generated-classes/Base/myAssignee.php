...
/**
 * Base class that represents a row from the 'myassignee' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class myAssignee implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\myAssigneeTableMap';
    ...
    /**
     * The value for the assigneename field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\myAssignee object.
     */
    ...
    /**
     * Compares this with another <code>myAssignee</code> instance.  If
     * <code>obj</code> is an instance of <code>myAssignee</code>, delegates to
     * <code>equals(myAssignee)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|myAssignee The current object, for fluid interface
     */
    ...
    /**
     * Get the [assigneename] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[myAssigneeTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [assigneename] column.
     *
     * @param string $v new value
     * @return $this|\myAssignee The current object (for fluent API support)
     */
    public function setassigneeName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->assigneename !== $v) {
            $this->assigneename = $v;
            $this->modifiedColumns[myAssigneeTableMap::COL_ASSIGNEENAME] = true;
        }
    ...
    public function setSalary($v)
    {
        ...
        if ($this->salary !== $v) {
            $this->salary = $v;
            $this->modifiedColumns[myAssigneeTableMap::COL_SALARY] = true;
        }
    ...
    public function sethourlyRate($v)
    {
        ...
        if ($this->hourlyrate !== $v) {
            $this->hourlyrate = $v;
            $this->modifiedColumns[myAssigneeTableMap::COL_HOURLYRATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : myAssigneeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : myAssigneeTableMap::translateFieldName('assigneeName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->assigneename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : myAssigneeTableMap::translateFieldName('Salary', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildmyAssigneeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see myAssignee::setDeleted()
     * @see myAssignee::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildmyAssigneeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                myAssigneeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[myAssigneeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . myAssigneeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(myAssigneeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(myAssigneeTableMap::COL_ASSIGNEENAME)) {
            $modifiedColumns[':p' . $index++]  = 'assigneename';
        }
        if ($this->isColumnModified(myAssigneeTableMap::COL_SALARY)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'assigneename':
                        $stmt->bindValue($identifier, $this->assigneename, PDO::PARAM_STR);
                        break;
                    case 'salary':
    ...
    {
        $pos = myAssigneeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['myAssignee'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['myAssignee'][$this->hashCode()] = true;
        $keys = myAssigneeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setassigneeName($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setSalary($arr[$keys[2]]);
        }
    ...
    {
        $criteria = new Criteria(myAssigneeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(myAssigneeTableMap::COL_ID)) {
            $criteria->add(myAssigneeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(myAssigneeTableMap::COL_ASSIGNEENAME)) {
            $criteria->add(myAssigneeTableMap::COL_ASSIGNEENAME, $this->assigneename);
        }
        if ($this->isColumnModified(myAssigneeTableMap::COL_SALARY)) {
            $criteria->add(myAssigneeTableMap::COL_SALARY, $this->salary);
        }
        if ($this->isColumnModified(myAssigneeTableMap::COL_HOURLYRATE)) {
    ...
    {
        $criteria = ChildmyAssigneeQuery::create();
        $criteria->add(myAssigneeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \myAssignee (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \myAssignee Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(myAssigneeTableMap::DEFAULT_STRING_FORMAT);
    }
