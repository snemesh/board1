...
abstract class myAnalitic implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogYear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogkyear = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogMonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogmonth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogDataTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->worklogdatatime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogYearMonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogyearmonth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogAge', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogage = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : myAnaliticTableMap::translateFieldName('CountIssues', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countissues = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : myAnaliticTableMap::translateFieldName('CountIssuesPersent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countissuespersent = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : myAnaliticTableMap::translateFieldName('EstimatedHoursSubTask', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estimatedhourssubtask = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : myAnaliticTableMap::translateFieldName('LogedHours', TableMap::TYPE_PHPNAME, $indexType)];
