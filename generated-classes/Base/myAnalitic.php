...
abstract class myAnalitic implements ActiveRecordInterface
{
    ...
    public function setWorkLogHoursSum($v)
    {
        ...
        if ($this->workloghourssum !== $v) {
            ...
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGHOURSSUM] = true;
        }
    ...
    public function setWorkLogUserName($v)
    {
        ...
        if ($this->worklogusername !== $v) {
            ...
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGUSERNAME] = true;
        }
    ...
    public function setWorkLogLogin($v)
    {
        ...
        if ($this->workloglogin !== $v) {
            $this->workloglogin = $v;
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGLOGIN] = true;
        }
    ...
    public function setWorkLogYear($v)
    {
        ...
        if ($this->worklogkyear !== $v) {
            $this->worklogkyear = $v;
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGKYEAR] = true;
        }
    ...
    public function setWorkLogMonth($v)
    {
        ...
        if ($this->worklogmonth !== $v) {
            $this->worklogmonth = $v;
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGMONTH] = true;
        }
    ...
    public function setWorkLogDataTime($v)
    {
        ...
        if ($this->worklogdatatime !== null || $dt !== null) {
            if ($this->worklogdatatime === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->worklogdatatime->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGDATATIME] = true;
            }
    ...
    public function setWorkLogYearMonth($v)
    {
        ...
        if ($this->worklogyearmonth !== $v) {
            ...
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGYEARMONTH] = true;
        }
    ...
    public function setWorkLogAge($v)
    {
        ...
        if ($this->worklogage !== $v) {
            $this->worklogage = $v;
            $this->modifiedColumns[myAnaliticTableMap::COL_WORKLOGAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogHoursSum', TableMap::TYPE_PHPNAME, $indexType)];
            $this->workloghourssum = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogUserName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogusername = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogLogin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->workloglogin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogYear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogkyear = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogMonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogmonth = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogDataTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->worklogdatatime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogYearMonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogyearmonth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : myAnaliticTableMap::translateFieldName('WorkLogAge', TableMap::TYPE_PHPNAME, $indexType)];
            $this->worklogage = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : myAnaliticTableMap::translateFieldName('CountIssues', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countissues = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : myAnaliticTableMap::translateFieldName('CountIssuesPersent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countissuespersent = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : myAnaliticTableMap::translateFieldName('EstimatedHoursSubTask', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estimatedhourssubtask = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : myAnaliticTableMap::translateFieldName('RemainingHours', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 19; // 19 = myAnaliticTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGHOURSSUM)) {
            $modifiedColumns[':p' . $index++]  = 'workloghourssum';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGUSERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'worklogusername';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGLOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'workloglogin';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGKYEAR)) {
            $modifiedColumns[':p' . $index++]  = 'worklogkyear';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGMONTH)) {
            $modifiedColumns[':p' . $index++]  = 'worklogmonth';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGDATATIME)) {
            $modifiedColumns[':p' . $index++]  = 'worklogdatatime';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGYEARMONTH)) {
            $modifiedColumns[':p' . $index++]  = 'worklogyearmonth';
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGAGE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGHOURSSUM)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGHOURSSUM, $this->workloghourssum);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGUSERNAME)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGUSERNAME, $this->worklogusername);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGLOGIN)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGLOGIN, $this->workloglogin);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGKYEAR)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGKYEAR, $this->worklogkyear);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGMONTH)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGMONTH, $this->worklogmonth);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGDATATIME)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGDATATIME, $this->worklogdatatime);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGYEARMONTH)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGYEARMONTH, $this->worklogyearmonth);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_WORKLOGAGE)) {
            $criteria->add(myAnaliticTableMap::COL_WORKLOGAGE, $this->worklogage);
        }
        if ($this->isColumnModified(myAnaliticTableMap::COL_COUNTISSUES)) {
