...
abstract class myProjectData implements ActiveRecordInterface
{
    ...
    /**
     * The value for the totalspent field.
     *
     * @var        double
     */
    ...
    /**
     * Get the [totalspent] column value.
     *
     * @return double
     */
    ...
    public function setProjectName($v)
    {
        ...
        if ($this->projectname !== $v) {
            $this->projectname = $v;
            $this->modifiedColumns[myProjectDataTableMap::COL_PROJECTNAME] = true;
        }
    ...
    public function setTotalEstimated($v)
    {
        ...
        if ($this->totalestimated !== $v) {
            ...
            $this->modifiedColumns[myProjectDataTableMap::COL_TOTALESTIMATED] = true;
        }
    ...
    /**
     * Set the value of [totalspent] column.
     *
     * @param double $v new value
     * @return $this|\myProjectData The current object (for fluent API support)
     */
    public function setTotalSpent($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->totalspent !== $v) {
            $this->totalspent = $v;
            $this->modifiedColumns[myProjectDataTableMap::COL_TOTALSPENT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : myProjectDataTableMap::translateFieldName('ProjectName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->projectname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : myProjectDataTableMap::translateFieldName('Budget', TableMap::TYPE_PHPNAME, $indexType)];
            $this->budget = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : myProjectDataTableMap::translateFieldName('TotalEstimated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalestimated = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : myProjectDataTableMap::translateFieldName('TotalSpent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalspent = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : myProjectDataTableMap::translateFieldName('HourlyRate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hourlyrate = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : myProjectDataTableMap::translateFieldName('HourlyBuffer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hourlybuffer = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : myProjectDataTableMap::translateFieldName('PlannedValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->plannedvalue = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : myProjectDataTableMap::translateFieldName('ActualCost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->actualcost = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : myProjectDataTableMap::translateFieldName('EarnedValueForUs', TableMap::TYPE_PHPNAME, $indexType)];
            $this->earnedvalueforus = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : myProjectDataTableMap::translateFieldName('EarnedValueForClient', TableMap::TYPE_PHPNAME, $indexType)];
            $this->earnedvalueforclient = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : myProjectDataTableMap::translateFieldName('EarnedValueVarience', TableMap::TYPE_PHPNAME, $indexType)];
            $this->earnedvaluevarience = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : myProjectDataTableMap::translateFieldName('ScheduleVariance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->schedulevariance = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : myProjectDataTableMap::translateFieldName('CostVariance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->costvariance = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : myProjectDataTableMap::translateFieldName('SchedulePerformanceIndex', TableMap::TYPE_PHPNAME, $indexType)];
            $this->scheduleperformanceindex = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : myProjectDataTableMap::translateFieldName('CostPerformanceIndex', TableMap::TYPE_PHPNAME, $indexType)];
            $this->costperformanceindex = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : myProjectDataTableMap::translateFieldName('EstimateAtCompletionForClient', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estimateatcompletionforclient = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : myProjectDataTableMap::translateFieldName('VarianceAtCompletionForClient', TableMap::TYPE_PHPNAME, $indexType)];
            $this->varianceatcompletionforclient = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : myProjectDataTableMap::translateFieldName('CostAtCompletionForUs', TableMap::TYPE_PHPNAME, $indexType)];
            $this->costatcompletionforus = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : myProjectDataTableMap::translateFieldName('ToCompletePerformanceIndex', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 20; // 20 = myProjectDataTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(myProjectDataTableMap::COL_PROJECTNAME)) {
        ...
        if ($this->isColumnModified(myProjectDataTableMap::COL_TOTALESTIMATED)) {
            $modifiedColumns[':p' . $index++]  = 'totalestimated';
        }
        if ($this->isColumnModified(myProjectDataTableMap::COL_TOTALSPENT)) {
            $modifiedColumns[':p' . $index++]  = 'totalspent';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'totalestimated':
                        ...
                        break;
                    case 'totalspent':
                        $stmt->bindValue($identifier, $this->totalspent, PDO::PARAM_STR);
                        break;
                    case 'hourlyrate':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getTotalEstimated(),
            $keys[4] => $this->getTotalSpent(),
            $keys[5] => $this->getHourlyRate(),
            $keys[6] => $this->getHourlyBuffer(),
            $keys[7] => $this->getPlannedValue(),
            $keys[8] => $this->getActualCost(),
            $keys[9] => $this->getEarnedValueForUs(),
            $keys[10] => $this->getEarnedValueForClient(),
            $keys[11] => $this->getEarnedValueVarience(),
            $keys[12] => $this->getScheduleVariance(),
            $keys[13] => $this->getCostVariance(),
            $keys[14] => $this->getSchedulePerformanceIndex(),
            $keys[15] => $this->getCostPerformanceIndex(),
            $keys[16] => $this->getEstimateAtCompletionForClient(),
            $keys[17] => $this->getVarianceAtCompletionForClient(),
            $keys[18] => $this->getCostAtCompletionForUs(),
            $keys[19] => $this->getToCompletePerformanceIndex(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setBudget($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setTotalEstimated($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setTotalSpent($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setHourlyRate($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setHourlyBuffer($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setPlannedValue($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setActualCost($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setEarnedValueForUs($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setEarnedValueForClient($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setEarnedValueVarience($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setScheduleVariance($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setCostVariance($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setSchedulePerformanceIndex($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setCostPerformanceIndex($arr[$keys[15]]);
        }
        if (array_key_exists($keys[16], $arr)) {
            $this->setEstimateAtCompletionForClient($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setVarianceAtCompletionForClient($arr[$keys[17]]);
        }
        if (array_key_exists($keys[18], $arr)) {
            $this->setCostAtCompletionForUs($arr[$keys[18]]);
        }
        if (array_key_exists($keys[19], $arr)) {
            $this->setToCompletePerformanceIndex($arr[$keys[19]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(myProjectDataTableMap::COL_PROJECTNAME)) {
            $criteria->add(myProjectDataTableMap::COL_PROJECTNAME, $this->projectname);
        }
        if ($this->isColumnModified(myProjectDataTableMap::COL_BUDGET)) {
            $criteria->add(myProjectDataTableMap::COL_BUDGET, $this->budget);
        }
        if ($this->isColumnModified(myProjectDataTableMap::COL_TOTALESTIMATED)) {
            $criteria->add(myProjectDataTableMap::COL_TOTALESTIMATED, $this->totalestimated);
        }
        if ($this->isColumnModified(myProjectDataTableMap::COL_TOTALSPENT)) {
            $criteria->add(myProjectDataTableMap::COL_TOTALSPENT, $this->totalspent);
        }
        if ($this->isColumnModified(myProjectDataTableMap::COL_HOURLYRATE)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTotalSpent($this->getTotalSpent());
