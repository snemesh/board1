...
abstract class myDataStore implements ActiveRecordInterface
{
    ...
    /**
     * The value for the userspent field.
     *
     * @var        string
     */
    protected $userspent;
    ...
    /**
     * Get the [userspent] column value.
     *
     * @return string
     */
    public function getUserSpent()
    {
        return $this->userspent;
    }
    ...
    public function setIssueKey($v)
    {
        ...
        if ($this->issuekey !== $v) {
            $this->issuekey = $v;
            $this->modifiedColumns[myDataStoreTableMap::COL_ISSUEKEY] = true;
        }
    ...
    public function setSummary($v)
    {
        ...
        if ($this->summary !== $v) {
            $this->summary = $v;
            $this->modifiedColumns[myDataStoreTableMap::COL_SUMMARY] = true;
        }
    ...
    /**
     * Set the value of [userspent] column.
     *
     * @param string $v new value
     * @return $this|\myDataStore The current object (for fluent API support)
     */
    public function setUserSpent($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->userspent !== $v) {
            $this->userspent = $v;
            $this->modifiedColumns[myDataStoreTableMap::COL_USERSPENT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : myDataStoreTableMap::translateFieldName('Month', TableMap::TYPE_PHPNAME, $indexType)];
            $this->month = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : myDataStoreTableMap::translateFieldName('Day', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : myDataStoreTableMap::translateFieldName('IssueKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->issuekey = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : myDataStoreTableMap::translateFieldName('Summary', TableMap::TYPE_PHPNAME, $indexType)];
            $this->summary = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : myDataStoreTableMap::translateFieldName('UserSpent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userspent = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 12; // 12 = myDataStoreTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(myDataStoreTableMap::COL_ISSUEKEY)) {
            $modifiedColumns[':p' . $index++]  = 'issuekey';
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_SUMMARY)) {
            $modifiedColumns[':p' . $index++]  = 'summary';
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_USERSPENT)) {
            $modifiedColumns[':p' . $index++]  = 'userspent';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'summary':
                        ...
                        break;
                    case 'userspent':
                        $stmt->bindValue($identifier, $this->userspent, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getMonth(),
            $keys[7] => $this->getDay(),
            $keys[8] => $this->getYear(),
            $keys[9] => $this->getIssueKey(),
            $keys[10] => $this->getSummary(),
            $keys[11] => $this->getUserSpent(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setMonth($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setDay($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setYear($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setIssueKey($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setSummary($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setUserSpent($arr[$keys[11]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(myDataStoreTableMap::COL_ISSUEKEY)) {
            $criteria->add(myDataStoreTableMap::COL_ISSUEKEY, $this->issuekey);
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_SUMMARY)) {
            $criteria->add(myDataStoreTableMap::COL_SUMMARY, $this->summary);
        }
        if ($this->isColumnModified(myDataStoreTableMap::COL_USERSPENT)) {
            $criteria->add(myDataStoreTableMap::COL_USERSPENT, $this->userspent);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUserSpent($this->getUserSpent());
        if ($makeNew) {
            $copyObj->setNew(true);
