...
class myAnaliticNonBillTableMap extends TableMap
{
     ...
     */
    const COL_WORKLOGLOGIN = 'myanaliticnonbill.workloglogin';
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(myAnaliticNonBillTableMap::COL_ID => 0, myAnaliticNonBillTableMap::COL_PROJECTNAME => 1, myAnaliticNonBillTableMap::COL_ISSUEKEY => 2, myAnaliticNonBillTableMap::COL_INITIALESTIMATE => 3, myAnaliticNonBillTableMap::COL_NONBIL => 4, myAnaliticNonBillTableMap::COL_ASSIGNEE => 5, myAnaliticNonBillTableMap::COL_ESTIMATEDHOURSSUM => 6, myAnaliticNonBillTableMap::COL_WORKLOGHOURSSUM => 7, myAnaliticNonBillTableMap::COL_WORKLOGUSERNAME => 8, myAnaliticNonBillTableMap::COL_WORKLOGLOGIN => 9, myAnaliticNonBillTableMap::COL_WORKLOGKYEAR => 10, myAnaliticNonBillTableMap::COL_WORKLOGMONTH => 11, myAnaliticNonBillTableMap::COL_WORKLOGDATATIME => 12, myAnaliticNonBillTableMap::COL_WORKLOGYEARMONTH => 13, myAnaliticNonBillTableMap::COL_WORKLOGAGE => 14, myAnaliticNonBillTableMap::COL_COUNTISSUES => 15, myAnaliticNonBillTableMap::COL_COUNTISSUESPERSENT => 16, myAnaliticNonBillTableMap::COL_ESTIMATEDHOURSSUBTASK => 17, myAnaliticNonBillTableMap::COL_REMAININGHOURS => 18, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(myAnaliticNonBillTableMap::COL_WORKLOGLOGIN);
